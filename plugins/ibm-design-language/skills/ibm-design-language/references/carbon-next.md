...
## Flag names recorded in the earlier reference snapshot

Check which flags exist and their defaults in the target installed release. The list below is reference history, not a verified API contract for every version.
