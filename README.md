...
Permanent source package for `ibm-design-language@jp-personal`, currently stable 1.1.6. Private source repository: https://github.com/pmeglaw/ibm-design-language-plugin. The current release is `v1.1.6`; use its resolved commit and release checksums for recovery.

## Contents

- `plugins/ibm-design-language/`: the exact 103-file approved 1.1.6 plugin, including the visual casebook, sources, evaluator and tests.
- `.agents/plugins/marketplace.json`: portable Codex marketplace. Plugin paths resolve from this repository root.
- `releases/`: exact 1.1.6, 1.1.5 and 1.1.4 ZIPs, file manifests and checksums for recovery.
